...
<template>
    <div>
        <div
            ...
            class="fixed inset-0 z-40 flex items-center justify-center bg-black bg-opacity-50 px-2"
        ...
        >
            ...
            >
                ...
                <h2 class="mb-2 pr-8 text-xl font-semibold">Message Seller</h2>

                <p class="mb-4 text-sm text-gray-700 sm:mb-6 sm:text-base">
                    Have questions for the seller regarding this listing? Ask
                    them here.
                </p>

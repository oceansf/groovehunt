...
const userNavigation = [
    { name: "Profile", href: `/profile/${auth.value?.user?.id}`, method: "get", current: false },
                ...
                >
                    ...
                    >
                        <Link
                            ...
                            :method="link.method"
                            :class="[
                                'inline-flex items-center border-b-4 px-1 pt-1 text-sm font-semibold tracking-tight',
                                (
                                    link.href === '/'
                                        ? currentPath.split('?')[0] === '/'

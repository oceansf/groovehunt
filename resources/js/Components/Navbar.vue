...
<template>
    <nav class="z-40 w-full border-gray-200 border-b sticky top-0 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div
            class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4"
        >
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                <Disc class="h-8 w-8 text-black" />
                <span
            ...
            >
                ...
                >
                    <li>
                        <a
                            href="#"
                            class="block py-2 px-3 text-black bg-blue-700 rounded md:bg-transparent md:font-bold md:p-0"
                            aria-current="page"
                            >Market</a
                        >
                    </li>

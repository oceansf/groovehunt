...
class ListingFactory extends Factory
{
    public function definition(): array
    {
        ...
        $formats = [
            'Vinyl', // Covers: 12-LP, 7-single, 10-LP, 12-single, 12-EP, 7-EP, 78-RPM, picture-disc
            'CD', // Covers: cd-album, cd-single, cd-EP, sacd
            'Cassette', // Covers: cassette, cassette-single, dat
            'DVD', // Covers: dvd-audio, blu-ray-audio
            'Box Set' // Covers: vinyl-box-set, cd-box-set, cassette-box-set
        ];
